...
System.register(['aurelia-framework', '../container'], function (_export, _context) {
  ...
  var inject, Container, _createClass, _dec, _class, FORECAST_IO_URL, Weather;
  ...
  return {
    ...
    execute: function () {
      ...
      FORECAST_IO_URL = 'http://forecast.io/embed/';

      _export('Weather', Weather = (_dec = inject(Element), _dec(_class = function (_Container) {
        _inherits(Weather, _Container);
