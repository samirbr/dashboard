...
System.register(['aurelia-framework', '../container'], function (_export, _context) {
  ...
  var inject, Container, _createClass, _dec, _class, HtmlContent;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('HtmlContent', HtmlContent = (_dec = inject(Element), _dec(_class = function (_Container) {
        _inherits(HtmlContent, _Container);
      ...
      _export('HtmlContent', HtmlContent);
    }
  };
});
